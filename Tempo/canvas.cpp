...
void Canvas::drawPlayer() {
  ...
  glBegin(GL_QUADS);
    glTexCoord2f(0.0f, 0.0f); glVertex3f(0, 0, -1100.0f);
    glTexCoord2f(1.0f, 0.0f); glVertex3f(KINECT_DEPTH_WIDTH*2, 0, -1100.0f);
    glTexCoord2f(1.0f, 1.0f); glVertex3f(KINECT_DEPTH_WIDTH*2, KINECT_DEPTH_HEIGHT*2, -1100.0f);
    glTexCoord2f(0.0f, 1.0f); glVertex3f(0, KINECT_DEPTH_HEIGHT*2, -1100.0f);
  glEnd();
